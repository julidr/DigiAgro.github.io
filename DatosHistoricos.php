	...
	<div id="body">
		...
		<div id="menu2">
			<div class="list-group">
  				<a href="CapturaDatos.php"><button type="button" id="m2" class="list-group-item"><img src="ui/images/capture.png" id="imgS">&nbsp;Captura de Datos</button></a>
 				<button type="button" id="m2" class="list-group-item list-group-item-success"><img src="ui/images/history2.png" id="imgS">&nbsp;Datos Historicos</button>
			</div>
		</div>
		<div id="centro">
				<div id="hum">Datos Historicos</div>
				<table class='table'>
					<thead>
						      <tr>
						        <th>Fecha</th>
			...
			<button type="submit" id="actu" class="btn btn-success">Actualizar</button>
		</div>
		<div id="tablad">
